...
class AddForageableFragment : Fragment() {
    ...
    // TOD: Refactor the creation of the view model to take an instance of
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (id > 0) {
            ...
            // TOD: Observe a Forageable that is retrieved by id, set the forageable variable,
            //  and call the bindForageable method
            viewModel.getForageableById(id).observe(this.viewLifecycleOwner) {
                forageable = it
