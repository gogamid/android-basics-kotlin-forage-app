...
// TOD: pass a ForageableDao value as a parameter to the view model constructor
class ForageableViewModel(
    private val forageableDao: ForageableDao
) : ViewModel() {

    // TOD: create a property to set to a list of all forageables from the DAO
    val forageables: LiveData<List<Forageable>> = forageableDao.getAllForageables().asLiveData()

    // TOD : create method that takes id: Long as a parameter and retrieve a Forageable from the
    ...
    fun addForageable(
        ...
        // TOD: launch a coroutine and call the DAO method to add a Forageable to the database within it
    ...
    fun updateForageable(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            // TOD: call the DAO method to update a forageable to the database here
    ...
    fun deleteForageable(forageable: Forageable) {
        viewModelScope.launch(Dispatchers.IO) {
            // TOD: call the DAO method to delete a forageable to the database here
...
// TOD: create a view model factory that takes a ForageableDao as a property and
